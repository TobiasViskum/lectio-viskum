...
export async function getIsAuthenticated<K extends boolean | undefined>(props: FunctionProps, getFullResponse?: boolean | undefined): Promise<(K extends false ? APIResponse<MainType> : MainType) | (K extends false ? APIResponse<null> : null)> {
