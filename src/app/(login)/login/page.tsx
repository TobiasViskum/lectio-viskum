...
export default async function Login() {
  return (
    <div className="grid place-items-center pt-8 gap-y-8 sm:gp-y-16">
      ...
      <div className="w-full flex items-center flex-col gap-y-4">
        ...
        <SchoolSearch />
        <ScrollArea className="h-[512px] max-h-[55svh] w-full max-w-lg relative flex flex-col items-center text-center p-4">
